        ...
        <>
          ...
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="kv">
                ...
                <div className="v">
                  ...
                  {data.canonicalStatus && (
                    <span className="badge ml-2">{data.canonicalStatus}</span>
                  )}
                                 {" "}
                </div>
            ...
            <section>
              ...
               {" "}
              <div className="kv">
                                <div className="k">Links (Total)</div>
                <div className="v">{Links.total ?? 0}</div>               {" "}
                <div className="k">Internal</div>
                <div className="v">{Links.internal ?? 0}</div>               {" "}
                <div className="k">External</div>
                <div className="v">{Links.external ?? 0}</div>               {" "}
                <div className="k">Nofollow</div>
                <div className="v">{Links.nofollow ?? 0}</div>               {" "}
                <div className="k">Images (missing alt)</div>
                <div className="v">{data.images?.missingAlt ?? 0}</div>         
                   {" "}
              </div>
                         {" "}
            </section>
